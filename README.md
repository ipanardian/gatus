...
| `ui.uptime-statistics-periods` | Uptime statistic periods to display, in order. Supported values: `30d`, `7d`, `24h`, and `1h`. Use `[]` to hide all uptime statistics. | `[30d, 7d, 24h, 1h]` |
